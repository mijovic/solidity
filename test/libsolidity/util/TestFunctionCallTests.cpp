...
BOOST_AUTO_TEST_CASE(format_unsigned_singleline)
{
	...
	FunctionCall call{"f(uint8)", 0, FunctionCallValueCoin::Ether, arguments, expectations};
...
BOOST_AUTO_TEST_CASE(format_multiple_unsigned_singleline)
{
	...
	FunctionCall call{"f(uint8, uint8)", 0, FunctionCallValueCoin::Ether, arguments, expectations};
	call.omitsArrow = false;
	TestFunctionCall test{call};
...
BOOST_AUTO_TEST_CASE(format_signed_singleline)
{
	...
	FunctionCallExpectations expectations{vector<Parameter>{param}, false, string{}};
	FunctionCallArgs arguments{vector<Parameter>{param}, string{}};
	FunctionCall call{"f(int8)", 0, FunctionCallValueCoin::Ether, arguments, expectations};
	call.omitsArrow = false;
	TestFunctionCall test{call};
...
BOOST_AUTO_TEST_CASE(format_hex_singleline)
{
	...
	FunctionCallExpectations expectations{vector<Parameter>{param}, false, string{}};
	FunctionCallArgs arguments{vector<Parameter>{param}, string{}};
	FunctionCall call{"f(bytes32)", 0, FunctionCallValueCoin::Ether, arguments, expectations};
	call.omitsArrow = false;
	TestFunctionCall test{call};
...
BOOST_AUTO_TEST_CASE(format_hex_string_singleline)
{
	...
	FunctionCallExpectations expectations{vector<Parameter>{param}, false, string{}};
	FunctionCallArgs arguments{vector<Parameter>{param}, string{}};
	FunctionCall call{"f(string)", 0, FunctionCallValueCoin::Ether, arguments, expectations};
	call.omitsArrow = false;
	TestFunctionCall test{call};
...
BOOST_AUTO_TEST_CASE(format_bool_true_singleline)
{
	...
	FunctionCallExpectations expectations{vector<Parameter>{param}, false, string{}};
	FunctionCallArgs arguments{vector<Parameter>{param}, string{}};
	FunctionCall call{"f(bool)", 0, FunctionCallValueCoin::Ether, arguments, expectations};
	call.omitsArrow = false;
	TestFunctionCall test{call};
...
BOOST_AUTO_TEST_CASE(format_empty_byte_range)
{
	...
	FunctionCallExpectations expectations{vector<Parameter>{param}, false, string{}};
	FunctionCallArgs arguments{vector<Parameter>{}, string{}};
	FunctionCall call{"f()", 0, FunctionCallValueCoin::Ether, arguments, expectations};
	call.omitsArrow = false;
	TestFunctionCall test{call};
